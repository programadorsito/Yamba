...
public class StatusProvider extends ContentProvider {
    ...
    public String getType(Uri uri) {
        switch (sURIMatcher.match(uri)) {
            case StatusContract.STATUS_DIR:return StatusContract.STATUS_TYPE_DIR;
            case StatusContract.STATUS_ITEM:return StatusContract.STATUS_TYPE_ITEM;
            default:
                throw new IllegalArgumentException(uri+" Direccion ilegal");
        }
    }
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        if (sURIMatcher.match(uri) != StatusContract.STATUS_DIR) {
            throw new IllegalArgumentException("Direccion ilegal :  " + uri);
        }
    ...
    public int update(Uri uri, ContentValues values, String selection,String[] selectionArgs) {
        ...
        Log.d(TAG, ret + "registros actualizados");
        return ret;
    }
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        Log.d(TAG, "Registros eliminados: " + ret);
        return ret;
    }
    ...
    public Cursor query(Uri uri, String[] projection, String selection,String[] selectionArgs, String sortOrder) {
        ...
        switch (sURIMatcher.match(uri)) {
            ...
            case StatusContract.STATUS_ITEM:
                ...
                break;
            default:
                throw new IllegalArgumentException(uri+" esta mal ingresada");
        }
        ...
        Log.d(TAG, "Se han consultado : "+cursor.getCount() + "registros");
        return cursor;
    }
}